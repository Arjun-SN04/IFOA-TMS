...
// ─── Transporter ──────────────────────────────────────────────────────────────
// IMPORTANT: Never cache the transporter. Render and cloud hosts close idle
// SMTP connections; a cached transporter causes silent send failures.
function getTransporter() {
  ...
  // Port 465 + SSL works reliably on Render and all cloud platforms.
  // Port 587 STARTTLS is frequently blocked by cloud outbound firewalls.
...
// ─── IFOA logo base64 (embedded inline — no file path needed on Render) ───────
const LOGO_BASE64 =
...
<table width="100%" cellpadding="0" cellspacing="0" style="background:#f1f5f9;padding:32px 16px;">
  <tr><td align="center">
    <table width="600" cellpadding="0" cellspacing="0"
      ...
      <tr>
        <td bgcolor="#ffffff" style="background-color:#ffffff;padding:20px 40px 16px;border-bottom:3px solid #0f172a;">
          <table width="100%" cellpadding="0" cellspacing="0" border="0" bgcolor="#ffffff" style="background-color:#ffffff;">
            <tr>
              <td bgcolor="#ffffff" width="150" style="background-color:#ffffff;vertical-align:middle;padding:6px 16px 6px 0;">
                <img src="cid:ifoa_logo" alt="IFOA" width="120" height="auto" style="display:block;border:0;" />
              </td>
              <td bgcolor="#ffffff" align="right" style="background-color:#ffffff;vertical-align:middle;">
      ...
      <tr>
        <td style="background:linear-gradient(135deg,#0f172a 0%,#1e3a5f 100%);padding:22px 40px 20px;">
          <h1 style="margin:0;font-size:24px;font-weight:800;color:#ffffff;line-height:1.2;">Submission Confirmed</h1>
          <p style="margin:6px 0 0;font-size:13px;color:#94a3b8;">Training enrollment received successfully</p>
        </td>
      </tr>
      ...
      <tr>
        <td style="padding:32px 40px 0;">
          ...
          <p style="margin:0 0 24px;font-size:15px;color:#334155;line-height:1.6;">
            ...
            <strong>${airlineName}</strong>. Below is a summary of the
          ...
          <table width="100%" cellpadding="0" cellspacing="0"
            ...
            <tr><td style="padding:20px 24px;">
              <p style="margin:0 0 4px;font-size:10px;font-weight:700;letter-spacing:1.5px;color:#64748b;text-transform:uppercase;">
                Submission Summary
              </p>
              <table width="100%" cellpadding="0" cellspacing="0" style="margin-top:14px;">
                <tr>
                  <td style="padding:6px 0;font-size:13px;color:#64748b;width:42%;">Training Type</td>
                  <td style="padding:6px 0;font-size:13px;color:#0f172a;font-weight:600;">${trainingType} - ${typeLabel}</td>
                </tr>
                <tr>
                ...
                <tr>
                  ...
                  <td style="padding:6px 0;font-size:13px;color:#166534;font-weight:700;">${count} enrolled</td>
                </tr>
                <tr>
          ...
          <p style="margin:0 0 10px;font-size:12px;font-weight:700;color:#334155;text-transform:uppercase;letter-spacing:1px;">
            Enrolled Participants (${count})
          </p>
          <table width="100%" cellpadding="0" cellspacing="0"
            style="border:1px solid #e2e8f0;margin-bottom:28px;">
            <thead>
              <tr style="background:#0f172a;">
                <th style="padding:10px 16px;font-size:10px;font-weight:700;color:#94a3b8;text-align:left;width:32px;">#</th>
                <th style="padding:10px 16px;font-size:10px;font-weight:700;color:#94a3b8;text-align:left;">Full Name</th>
                <th style="padding:10px 16px;font-size:10px;font-weight:700;color:#94a3b8;text-align:left;">Department</th>
              </tr>
            </thead>
          ...
          <table width="100%" cellpadding="0" cellspacing="0"
            ...
            <tr><td style="padding:16px 20px;">
              ...
              <p style="margin:0;font-size:13px;color:#3b4f9e;line-height:1.6;">
                Your records are now under review by the IFOA team. Certificates will be generated once
                training is verified. Submitted records are locked - only IFOA administrators can make changes.
              </p>
            </td></tr>
          </table>
        </td>
      ...
      <tr>
        <td style="background:#f8fafc;border-top:1px solid #e2e8f0;padding:22px 40px;">
          ...
          <p style="margin:0;font-size:12px;color:#94a3b8;line-height:1.6;">
            This is an automated email. For questions contact
...
async function sendSubmissionConfirmation(opts) {
  ...
  try {
    await transporter.sendMail({
      from: `"${process.env.SMTP_FROM_NAME || 'IFOA'}" <${process.env.SMTP_FROM_EMAIL || process.env.SMTP_USER}>`,
      to:   toEmail,
      subject,
    ...
    console.error('[email] Failed to send confirmation to', toEmail, '-', err.message);
    ...
    <table width="600" cellpadding="0" cellspacing="0"
      ...
      <tr>
        <td style="background:#f8fafc;border-top:1px solid #e2e8f0;padding:20px 40px;">
          <p style="margin:0;font-size:12px;color:#94a3b8;">International Flight Operations Academy (IFOA)</p>
        </td>
      </tr>
    </table>
  </td></tr>
